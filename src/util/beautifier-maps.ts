...
export const BEAUTIFIER_EVENT_MAP = {
  ...
  executionReportEvent: {
    ...
    Cs: 'counterSymbol',
    pl: 'preventedExecutionQuantity',
    pL: 'preventedExecutionPrice',
    pY: 'preventedExecutionQuoteQty',
  },
  PM_PRO_ACCOUNT_UPDATEEvent: {
    ...
    avb: 'availableBalance',
    vmw: 'virtualMaxWithdraw',
  },
  tradeEvent: {
    e: 'eventType',
    E: 'eventTime',
