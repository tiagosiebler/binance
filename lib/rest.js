...
class BinanceRest {
    ...
    queryOCO(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'api/v3/orderList', 'SIGNED');
    }

    queryAllOCO(query = {}, callback) {
