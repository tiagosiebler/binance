...
class BinanceRest {
    ...
    const createQueryObject = (query,addTimeStamp,skipConstruct)=>{
      if (_.isString(query) && skipConstruct !== true) {
          query = {
              symbol: query
          }
      }
      if (addTimeStamp === true && !query.timestamp) {
    ...
    depth(query = {}, callback) {
        return this._makeRequest(createQueryObject(query), callback, 'api/v1/depth');
    }

    aggTrades(query = {}, callback) {
        return this._makeRequest(createQueryObject(query), callback, 'api/v1/aggTrades');
    }
    ...
    ticker24hr(query = {}, callback) {
        return this._makeRequest(createQueryObject(query), callback, 'api/v1/ticker/24hr');
    }
    ...
    queryOrder(query = {}, callback) {
        ...
        return this._makeRequest(createQueryObject(query,true), callback, 'api/v3/order', 'SIGNED');
    }

    cancelOrder(query = {}, callback) {
        return this._makeRequest(createQueryObject(query,true), callback, 'api/v3/order', 'SIGNED', 'DELETE');
    }

    openOrders(query = {}, callback) {
        return this._makeRequest(createQueryObject(query,true), callback, 'api/v3/openOrders', 'SIGNED');
    }

    allOrders(query = {}, callback) {
        return this._makeRequest(createQueryObject(query,true), callback, 'api/v3/allOrders', 'SIGNED');
    }
    ...
    account(query = {}, callback) {
        if (_.isFunction(query)) {
          ...
          query = createQueryObject(query,true,true)
        }
        return this._makeRequest(query, callback, 'api/v3/account', 'SIGNED');
    }

    myTrades(query = {}, callback) {
        return this._makeRequest(createQueryObject(query,true), callback, 'api/v3/myTrades', 'SIGNED');
    }

    withdraw(query = {}, callback) {
        return this._makeRequest(createQueryObject(query,true,true), callback, 'wapi/v3/withdraw.html', 'SIGNED', 'POST');
    }

    depositHistory(query = {}, callback) {
        return this._makeRequest(createQueryObject(query,true), callback, 'wapi/v3/depositHistory.html', 'SIGNED', 'GET');
    }

    withdrawHistory(query = {}, callback) {
        return this._makeRequest(createQueryObject(query,true), callback, 'wapi/v3/withdrawHistory.html', 'SIGNED', 'GET');
    }

    depositAddress(query = {}, callback) {
        return this._makeRequest(createQueryObject(query,true), callback, 'wapi/v3/depositAddress.html', 'SIGNED', 'GET');
    }
    ...
    keepAliveUserDataStream(query = {}, callback) {
        return this._makeRequest(createQueryObject(query), callback, 'api/v1/userDataStream', 'API-KEY', 'PUT');
    }

    closeUserDataStream(query = {}, callback) {
        return this._makeRequest(createQueryObject(query), callback, 'api/v1/userDataStream', 'API-KEY', 'DELETE');
    }
}
