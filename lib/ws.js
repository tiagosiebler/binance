...
class BinanceWS {
    ...
    onBookTicker(symbol, eventHandler) {
        return this._setupWebSocket(eventHandler, this.streams.bookTicker(symbol));
    }

    onBookTickers(eventHandler) {
        return this._setupWebSocket(eventHandler, this.streams.bookTickers());
    }
