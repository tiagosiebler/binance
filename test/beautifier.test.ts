import type {
  ...
  WsMessageFuturesUserDataAlgoUpdateEventRaw,
} from '../src/index.js';
      ...
      it('should beautify USDM futures ALGO_UPDATE events', () => {
        const data = {
          ...
          o: {
            ...
            tt: 0,
            gtd: 0,
          } as WsMessageFuturesUserDataAlgoUpdateEventRaw['o'],
        };
        expect(beautifier.beautifyWsMessage(data, data.e)).toStrictEqual({
          ...
          algoOrder: {
            ...
            triggerTime: 0,
            goodTillDate: 0,
          } as WsMessageFuturesUserDataAlgoUpdateEventFormatted['algoOrder'],
        });
      });
